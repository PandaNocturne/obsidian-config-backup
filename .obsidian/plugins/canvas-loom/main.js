...
var BadgeService = class {
  ...
  async setBadges(nodes, badgeTexts) {
    try {
      ...
      new import_obsidian6.Notice(t("notice.batchBadgesSet", { count: updatedCount }));
      return updatedCount;
    } catch (error) {
  ...
  async removeBadges(nodes) {
    try {
      ...
      await this.canvasAdapter.requestSave();
      this.refreshBadgeDomSoon();
      new import_obsidian6.Notice(t("notice.batchBadgesRemoved", { count: updatedCount }));
      return updatedCount;
    } catch (error) {
  ...
  isValidBadgeNode(node) {
    ...
    const isMarkdownEmbed = ((_b = node.nodeEl) == null ? void 0 : _b.querySelector(".markdown-embed")) !== null;
...
var ContentService = class {
  ...
  async buildMergedContent(options) {
    ...
    const includeBadgePrefix = (_a = options.includeBadgePrefix) != null ? _a : options.order === "badge";
...
var MergeService = class {
  constructor(app, canvasAdapter, contentService, vaultAdapter, searchReplaceService, performanceService, getMergeCleanupMode) {
    this.app = app;
    this.canvasAdapter = canvasAdapter;
  ...
  async buildMergeContent(target, source, options) {
    ...
    const result = await this.measure("merge.buildContent", {
      ...
      var _a;
      return this.contentService.buildMergedContent({
        ...source,
        order: (options == null ? void 0 : options.order) || "position",
        sortPriority: (options == null ? void 0 : options.sortPriority) || "yx",
        manualOrderIds: options == null ? void 0 : options.manualOrderIds,
        includeBadgePrefix: (_a = options == null ? void 0 : options.includeBadgePrefix) != null ? _a : true,
        cardSeparator: options == null ? void 0 : options.cardSeparator
      });
    });
...
function hasEditingNode(selection) {
...
function isEditingNode(node) {
  ...
  return Boolean((_b = nodeEl.querySelector) == null ? void 0 : _b.call(
    nodeEl,
...
var CanvasSelectionToolbarService = class {
  ...
  stop() {
    ...
    this.workspaceEventRefs = [];
    activeDocument.querySelectorAll(`.${BUTTON_CLASS}, .${AUTO_HEIGHT_BUTTON_CLASS}, .${POPOVER_CLASS}`).forEach((element) => element.remove());
  }
  scheduleInjection() {
...
var CanvasGlobalFindReplaceToolbarService = class {
  ...
  renderPanel(context) {
    let panel = activeDocument.body.querySelector(`.${PANEL_CLASS}`);
    if (!panel) {
  ...
  clearNodeHighlight(canvas, nodeId) {
    var _a, _b, _c;
    const node = ((_a = canvas.nodes) == null ? void 0 : _a.get(nodeId)) || null;
    (_b = node == null ? void 0 : node.nodeEl) == null ? void 0 : _b.removeClass(ACTIVE_CARD_CLASS);
    (_c = node == null ? void 0 : node.nodeEl) == null ? void 0 : _c.removeClass(ACTIVE_CARD_PULSE_CLASS);
  }
  clearHighlightedCardIfChanged(canvas, nodeId) {
  ...
  positionPanel() {
    ...
    const panel = activeDocument.body.querySelector(`.${PANEL_CLASS}`);
  ...
  removePanel() {
    activeDocument.body.querySelectorAll(`.${PANEL_CLASS}`).forEach((element) => element.remove());
  }
...
var CanvasLabelScaleService = class {
  ...
  resolveCanvasWrapper(view) {
    ...
    if (((_a = view.canvas) == null ? void 0 : _a.wrapperEl) instanceof HTMLElement) {
...
var OpenBatchBadgeModalCommand = class {
  constructor(openModal, selection, canEditSelection, settings3) {
    this.openModal = openModal;
  ...
  getDescription() {
    return t("commands.batchEditBadge", void 0, { settings: this.settings });
  }
};
...
var BatchBadgeModal = class extends import_obsidian16.Modal {
  ...
  createBadgeSequence(startBadge, count) {
...
var CanvasLoomPlugin = class extends import_obsidian20.Plugin {
  ...
  registerCanvasMenus() {
    ...
    this.registerEvent(this.app.workspace.on("canvas:selection-menu", (menu3, canvas) => {
      ...
      this.addSelectionMenuCommands(menu3, selection, this.resolveCanvasFileForCanvas(canvas));
    }));
  }
  ...
  addSelectionMenuCommands(menu3, selection, canvasFile) {
    var _a;
    ...
    if (this.badgeService && this.hasBadgeEditableSelection(selectionArray)) {
      ...
      this.commandRegistry.addCommandToMenu(menu3, "open-batch-badge-modal", this.translate("menu.batchEditBadge"), "tag");
    }
  ...
  hasActiveCanvasCard() {
    ...
    if (activeElement instanceof HTMLElement && (!rootEl || rootEl.contains(activeElement)) && activeElement.closest(".canvas-node")) {
      return true;
    }
  ...
  registerHotkeys() {
    this.addCommand({
      ...
      hotkeys: import_obsidian20.Platform.isMacOS ? [{ modifiers: ["Ctrl"], key: "f" }] : [],
